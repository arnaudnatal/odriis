...
save"_temp\_temp_NEEMSIS1-kilm", replace
****************************************
* END
...
preserve
use"outcomes/NEEMSIS1-occupnew.dta", clear
keep if dummymainoccupation==1
keep HHID2016 INDID2016 kindofwork_new annualincome occupation profession sector occupationname
rename kindofwork_new kindofwork
save"_temp/NEEMSIS1_kow.dta", replace
restore
merge 1:1 HHID2016 INDID2016 using "_temp/NEEMSIS1_kow.dta"
drop _merge


* Merge Edu
merge 1:1 HHID2016 INDID2016 using "_temp/_temp_NEEMSIS1-kilm"
drop _merge
...
* Merge Kindofwork de la moc
merge 1:1 HHID2016 INDID2016 using "_temp/_temp_NEEMSIS1-kilm_v2.dta"
drop _merge
ta employed
...
keep HHID2016 INDID2016 occupation kindofwork str_kindofwork profession sector occupationname educ_attainment educ_attainment2 agecat workingage youth employed unemployed employee selfemployed


save"_temp/_temp_NEEMSIS1-kilm_v3.dta", replace
****************************************
* END
...
* Merge Kindofwork de la moc
merge 1:1 HHID2016 INDID2016 using "_temp/_temp_NEEMSIS1-kilm_v3.dta"
drop _merge
ta employed
...
***
keep HHID2016 INDID2016 occupation kindofwork str_kindofwork profession_mainoccup sector_mainoccup occupationname_mainoccup educ_attainment educ_attainment2 agecat workingage youth employed unemployed employee selfemployed sector_kilm4 agri industry services sector_kilm4_V2

save"_temp/_temp_NEEMSIS1-kilm_v4.dta", replace
save"outcomes/NEEMSIS1-kilm.dta", replace
****************************************
* END
...
* Merge Kindofwork de la moc
merge 1:1 HHID2016 INDID2016 using "_temp/_temp_NEEMSIS1-kilm_v4.dta"
drop _merge
ta employed
...
***
keep HHID2016 INDID2016 occupation kindofwork str_kindofwork profession_mainoccup sector_mainoccup occupationname_mainoccup educ_attainment educ_attainment2 agecat workingage youth employed unemployed employee selfemployed sector_kilm4 agri industry services sector_kilm4_V2 kilm5 elementaryoccup

save"_temp/_temp_NEEMSIS1-kilm_v5.dta", replace
save"outcomes/NEEMSIS1-kilm.dta", replace
****************************************
* END
