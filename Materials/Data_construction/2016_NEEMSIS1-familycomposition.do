...
keep if _merge==3
drop _merge
merge m:m HHID_panel INDID2016 using "keypanel-Indiv_wide", keepusing(INDID_panel agecorr2016 sex2016 relationshiptohead2016 age2016)
keep if _merge==3
drop _merge
