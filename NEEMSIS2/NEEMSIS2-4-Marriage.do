...
replace mar=1 if HHID2010=="SIKARU250"
...
keep if mar==1
sort INDID2010
list INDID2010 reasonlefthome name maritalstatus maritalstatus_p16 sex_p16 if version=="NEEMSIS2_APRIL" | version=="NEEMSIS2_NEW_APRIL", clean noobs
restore
/*
      HHID2010        marriedname  
            21              Deepa  
    ...
    ANTKARU278        Sivashakthi  
     ...
     VENKOR219       Bakyalakshmi 
      ...
      INDID2010   reasonlef~e                     name          maritalstatus      maritalstatus_p16   sex_p16  
     ADSEM121/4   Get married                   Geetha                      .                Married    Female  
    ANDNAT370/4             .                Vadivelan                Married   Unmarried (above 10)      Male  
    SIKARU250/3   Get married                   Vijaya                      .                Married    Female  
*/	  
...
*INDID 3
foreach x in 103 55 64 71 PSSEM93 RAMTP298 RANAT340 VENEP48 VENEP54 21 26 RAKARU258 RAMPO27 RAMTP301 SINAT333 VENGP177 ANDMTP325 SISEM101 ANTGP162 ANTMP37 SIKARU250 {
replace marriedid="3" if marriedid_o=="31" & HHID2010=="`x'"
}

*INDID 4
foreach x in 7 99 ADSEM123 ANDMTP329 RAOR379 VENGP179 RAMTP305 RAEP67 RAEP69 VENGP180 ADSEM121 ANDNAT370{
