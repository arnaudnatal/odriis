...
merge m:1 parent_key using "$directory\CLEAN\NEEMSIS_APPEND.dta", keepusing(householdid2020 HHID2010 startquestionnaire)
keep if _merge==3
drop _merge
...
rename _merge merge_marriage
sort merge_marriage

gen dummy_marriageindivnew=0
replace dummy_marriageindivnew=1 if marriedid>15 & marriedid!=.
