...
*Add caste, etc
merge m:1 HHID2010 INDID using "NEEMSIS2-HH_v15.dta", keepusing(parent_key HHID_panel HHID2010 householdid2020 villageid villagearea jatis caste INDID INDID_total INDID_former INDID_new INDID_left egoid name sex age edulevel)
drop if _merge==2
