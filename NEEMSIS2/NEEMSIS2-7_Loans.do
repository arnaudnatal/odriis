...
merge m:m parent_key INDID using "NEEMSIS2-HH_v14.dta", keepusing(HHID_panel HHID2010 submissiondate version_HH householdid2020 caste jatis)
sort _merge
keep if _merge==3
drop _merge
tab caste
...
drop _merge
merge m:1 householdid2020 INDID using "NEEMSIS2-HH_v14.dta", keepusing(annualincome_indiv annualincome_HH) 
drop if _merge==2
drop _merge
tab loansettled
tab householdid2020
