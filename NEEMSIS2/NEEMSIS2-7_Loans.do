...
merge m:m parent_key INDID using "NEEMSIS2-HH_v15.dta", keepusing(HHID_panel HHID2010 submissiondate version_HH householdid2020 caste jatis)
sort _merge
keep if _merge==3
drop _merge
tab caste
...
*Add caste, etc
merge m:1 HHID_panel INDID using "NEEMSIS2-HH_v15.dta", keepusing(parent_key HHID_panel HHID2010 householdid2020 villageid villagearea jatis caste INDID INDID_total INDID_former INDID_new INDID_left egoid name sex age edulevel)
drop if _merge==2
...
----------------------------------------------------------------
     ...
     lender4 |         N      mean       p50       min       max
-------------+--------------------------------------------------
         WKP |       234  41.14316  32.33333  .8333333       600
   Relatives |        20  25.36693  23.00267         2        72
      Labour |        84  23.84127        20       2.4       108
 Shop keeper |         5  29.38424        30  .9212121        70
Moneylenders |        25  17.43122     13.32  .7272727  73.77333
     Friends |       369  23.33736        15  .0057143       144
 Microcredit |        72  18.66582        10   .007875        80
        Bank |       103  17.21387  13.33333       .21     122.4
     Thandal |        75   10.7839        10         1        60
-------------+--------------------------------------------------
       Total |       987  25.59012  16.66667  .0057143       600
----------------------------------------------------------------
...
drop _merge
merge m:1 householdid2020 INDID using "NEEMSIS2-HH_v15.dta", keepusing(annualincome_indiv annualincome_HH) 
drop if _merge==2
drop _merge
tab loansettled
tab householdid2020
...
*INDIV
bysort householdid2020 INDID: egen imp1_ds_tot_indiv=sum(imp1_debt_service)
bysort householdid2020 INDID: egen imp1_is_tot_indiv=sum(imp1_interest_service)
