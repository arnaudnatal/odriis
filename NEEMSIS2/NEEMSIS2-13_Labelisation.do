...
drop totalrepaid2 interestpaid2 principalpaid annualincome_indiv annualincome_HH setofloansbyborrower detailsloanbyborrower_count setofdetailsloanbyborrower loanreasongivenlabel key2 key3 setofmainloans merge_mainloans key householdid2020 submissiondate_o
...
foreach v in loanlender_rec edulevel loan_database loanduration lender_cat reason_cat lender2 lender3 lender4 lender4_rec loanduration_month yratepaid monthlyinterestrate debt_service interest_service imp_principal imp1_interest imp1_totalrepaid_year imp1_debt_service imp1_interest_service dummymainloans loans_indiv loans_HH loans_gm_indiv loans_gm_HH loans_g_indiv loans_g_HH loanamount_g_indiv loanamount_g_HH loanamount_gm_indiv loanamount_gm_HH loanamount_indiv loanamount_HH imp1_ds_tot_indiv imp1_is_tot_indiv imp1_ds_tot_HH imp1_is_tot_HH{
label variable `v' "Construction -- Arnaud"
}
